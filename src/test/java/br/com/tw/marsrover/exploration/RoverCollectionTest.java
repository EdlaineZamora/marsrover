...
public class RoverCollectionTest {
    ...
    public void createsRoverCollectionsToOneRoverAndOneMoviment() throws Exception {
        ...
        Rover expectedRover = new Rover(initialPosition, Direction.N, Arrays.asList(oneMovimentToRight));
    ...
    public void createsRoverCollectionsToOneRoverAndTwoMoviments() throws Exception {
        ...
        Rover expectedRover = new Rover(initialPosition, Direction.N, asList(oneMovimentToRight, oneMovimentToLeft));
    ...
    public void createsRoverCollectionsWithTwoRovers() throws Exception {
        ...
        Rover expectedFirstRover = new Rover(initialPosition, Direction.N, Arrays.asList(oneMovimentToRight));
        Rover expectedSecondRover = new Rover(initialPosition, Direction.S, Arrays.asList(oneMovimentToRight));
    ...
    public void movesRoverWithOneMovimentRM() throws Exception {
        Rover expectedRover = new Rover(new Position("1 0"), Direction.E, Collections.emptyList());
